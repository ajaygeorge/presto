...
import com.facebook.presto.tests.sqllogictest.SqlLogicTest.DatabaseDialect;
...
public class SqlLogicTestResult
{
    ...
    private final List<SqlLogicTestStatement> testStatements;
    ...
    public SqlLogicTestResult(DatabaseDialect databaseDialect)
    {
        ...
        this.testStatements = new ArrayList<>();
    }
    ...
    public void addTestStatements(List<SqlLogicTestStatement> testStatements)
    {
        this.testStatements.addAll(testStatements);
    }
    ...
    public List<SqlLogicTestStatement> getTestStatements()
    {
        return ImmutableList.copyOf(testStatements);
    }
