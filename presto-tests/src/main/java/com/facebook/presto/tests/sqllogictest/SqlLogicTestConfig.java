...
import static com.facebook.presto.tests.sqllogictest.SqlLogicTest.DatabaseDialect.ALL;

public class SqlLogicTestConfig
{
    private Path testFilesRootPath = Paths.get("src/test/resources/sqllogictest/");
    private Path resultPath = Paths.get("src/test/resources/sqllogictest/");
